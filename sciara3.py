    ...
    if isinstance(data, dict):
        ...
        if len(current_translations.keys()) > 0:
            ...
            table_lines.append({
                ...
                "translation_1_back": create_diff_html(current_translations[source_language], unique_translations_back[0]),
                ...
                "translation_2_back": create_diff_html(current_translations[source_language], unique_translations_back[1]) if len(unique_translations_back) > 1 else "",
                ...
                "translation_3_back": create_diff_html(current_translations[source_language], unique_translations_back[2]) if len(unique_translations_back) > 2 else "",
                ...
                "translation_4_back": create_diff_html(current_translations[source_language], unique_translations_back[3]) if len(unique_translations_back) > 3 else "",
                ...
                "translation_5_back": create_diff_html(current_translations[source_language], unique_translations_back[4]) if len(unique_translations_back) > 4 else "",
