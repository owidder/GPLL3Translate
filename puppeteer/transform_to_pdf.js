...
let combinedHtml = '<html><head><style>table { width: 100%; table-layout: fixed; } td, th { word-wrap: break-word; } img { max-width: 100%; } .page-break { page-break-after: always; }</style></head><body>';
